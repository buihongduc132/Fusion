...
This project is indexed by GitNexus as **Fusion** (61571 symbols, 116238 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Fusion/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Fusion/clusters` | All functional areas |
| `gitnexus://repo/Fusion/processes` | All execution flows |
| `gitnexus://repo/Fusion/process/{name}` | Step-by-step execution trace |
